...
net = dualstream_v2()
model_dir = "/home/htihe/MDPI/code/Final_Integration/runs/"
...
for epoch in range(0, epoch_num):
    ...
    for i, data in enumerate(salobj_dataloader):
        ...
        if ite_num % 6000 == 0:  # save model every 2000 iterations
            ...
            writer.add_scalar('training loss',running_loss/100,epoch*len(salobj_dataloader)+i)
            writer.add_scalar('lung region loss', loss_lung / 100, epoch * len(salobj_dataloader) + i)
            writer.add_scalar('Infection loss', loss_infection / 100, epoch * len(salobj_dataloader) + i)
