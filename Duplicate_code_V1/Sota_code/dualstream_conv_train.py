...
data_dir = '/home/htihe/MDPI/Data/Task1/train/WithPneo//'
tra_image_dir = 'png_images/'
tra_label_dir = 'png_lungmask_2/'
tra_label2_dir = 'png_masks/'

image_ext = '.png'
label_ext = '.png'

model_dir = "/home/htihe/MDPI/ckpt/0722/"
...
# define the net
net = dualstream()
#net.load_state_dict(torch.load("/home/htihe/ECCV2022/ckpt/DualStream_conv_try3/dualstream_bsi_itr_108000_train_1.366660_tar_0.145548.pth"))
...
for epoch in range(0, epoch_num):
    ...
    for i, data in enumerate(salobj_dataloader):
        ...
        if ite_num % 6000 == 0:  # save model every 2000 iterations
            ...
            torch.save(net.state_dict(), model_dir + "dualstream_bsi_itr_%d_train_%3f_tar_%3f.pth" % (ite_num, running_loss / ite_num4val, running_tar_loss / ite_num4val))
            running_loss = 0.0
            running_tar_loss = 0.0
