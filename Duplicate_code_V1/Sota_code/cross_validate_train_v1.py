...
data_dir = '/home/htihe/MDPI/Data/kfold/1/train/'
tra_image_dir = 'image/'
...
test_image_dir = '/home/htihe/MDPI/Data/kfold/1/test/image/'
...
net = dualstream_v1()
model_dir = "/home/htihe/MDPI/code/Final_Integration/ckpt/Cross_validate/Dualstream_v1/"
...
optimizer=optim.AdamW(net.parameters(), lr=0.0003, betas=(0.9, 0.999), weight_decay=0)
# ------- 5. training process --------
...
for epoch in range(0, epoch_num):
    ...
    if epoch%10==0:  # save model every 2000 iterations
        ...
        prediction_dir = "/home/htihe/MDPI/code/Final_Integration/cross_validate_v1/"+str(epoch)
