...
if __name__ == '__main__':
  ...
  for i in range(1,40):
    image_dir = '/home/htihe/MDPI/Data/kfold/1/test/image/'
    prediction_dir = "/home/htihe/MDPI/Final_result/Cross_validate/1019/"+str(i)+"0/"
    model_dir = '/home/htihe/MDPI/code/Final_Integration/ckpt/Cross_validate/Dualstream_v2_transfer/Dualstream_v2_bsi_itr_'+str(i)+'0_.pth'
