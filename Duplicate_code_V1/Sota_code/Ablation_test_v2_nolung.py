...
from model.Dualstream_v2.conv_decoder import dualstream_noatt_nolung as dualstream_noatt_nolung
...
if __name__ == '__main__':
    ...
    prediction_dir = '/home/htihe/MDPI/Final_result/Data_ver1/dualstream_v2_nolung/'
    model_dir = '/home/htihe/MDPI/dualstream_bsi_itr_216000_train_0.378737_tar_0.135557.pth'
    ...
    for i_test, data_test in enumerate(test_salobj_dataloader):
        ...
        infection_flow4,ms1_infection,ms2_infection,ms3_infection= net(inputs_test)
