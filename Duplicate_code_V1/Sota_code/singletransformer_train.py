...
tra_image_dir = 'Temp_image_3c_split_filter/'
tra_label_dir = 'Temp_Lung_Mask_split_filter/'

image_ext = '.png'
label_ext = '.png'

model_dir = "/home/htihe/ECCV2022/ckpt/VisionTransformer_lung2/"
...
optimizer=optim.AdamW(net.parameters(), lr=0.00006, betas=(0.9, 0.999), weight_decay=0.01)
# ------- 5. training process --------
...
for epoch in range(0, epoch_num):
    ...
    for i, data in enumerate(salobj_dataloader):
        ...
        d0 = net(inputs_v)
        loss = bce_ssim_loss(d0, labels_v)
