...
# define the net
net = dualstream_v1()
#net.load_state_dict(torch.load("/home/htihe/MDPI/code/Final_Integration/ckpt/Data_ver1/Dualstream_v1/Dualstream_v1_bsi_itr_90000_train_0.199056_tar_0.127231.pth"))
model_dir = "/home/htihe/MDPI/code/Final_Integration/ckpt/Data_ver1/Dualstream_v1_3/"
#net = dualstream_v2()
#model_dir = "/home/htihe/MDPI/code/Final_Integration/ckpt/Data_ver1/Dualstream_v2/"
...
for epoch in range(0, epoch_num):
    ...
    for i, data in enumerate(salobj_dataloader):
        ...
        loss2_lung, loss_lung = muti_bce_loss_fusion(lung_flow4, ms1_lung,ms2_lung,labels_lung_v)
        loss2_infection, loss_infection = muti_bce_loss_fusion(infection_flow4, ms1_infection,ms2_infection,labels_infection_v)
        ...
        if ite_num % 3000 == 0:  # save model every 2000 iterations

            torch.save(net.state_dict(), model_dir + "Dualstream_v1_bsi_itr_%d_train_%3f_tar_%3f.pth" % (ite_num, running_loss / ite_num4val, running_tar_loss / ite_num4val))
            running_loss = 0.0
            running_tar_loss = 0.0
