...
def resnet34(pretrained=False, **kwargs):
    ...
    if pretrained:
        pretrained_dict=model_zoo.load_url(model_urls['resnet34'],model_dir='/home/htihe/MDPI/code/Final_Integration/pretrained_ckpt')# Modify 'model_dir' according to your own path
